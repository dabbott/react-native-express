...
Any children elements should go between the opening tag, `<View>`, and closing tag `</View>`. Elements without children can using a self-closing tag, like `<View />`, as a shorthand.
...
Children are generally other elements, but can also any other kind of expression if wrapped in curly braces, `{ ... }`.
