...
> By default, props are compared for identity, essentially with `===`. To change this behavior, we can pass an optional comparator function as the 2nd argument to `memo`. See ([the React docs on memo](https://reactjs.org/docs/react-api.html#reactmemo))
