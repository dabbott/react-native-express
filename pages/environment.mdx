...
If you know you'll need custom native modules in your app, you'll want to use the `react-native` CLI to create your app. You can read how to do this on the Facebook docs for [environment setup](https://reactnative.dev/docs/environment-setup). Click on the "React Native CLI Quickstart" tab.
...
<Example panes={['editor']} code={appRegistry} />
