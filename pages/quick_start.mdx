...
We can just choose "blank" under "Managed workflow" when expo-cli is asking us to choose a template for this tutorial. More information about workflows can be found here(https://docs.expo.io/versions/v35.0.0/introduction/managed-vs-bare/).

Then type the name of the app, and slug(Required. The friendly url name for publishing.) in the next step.
