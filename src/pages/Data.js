...
**GraphQL** | [GraphQL](http://graphql.org) is a query language designed to power Facebook's mobile apps that makes working with hierarchical data simple and efficient, because it reduces the number of roundtrips between client and server significantly. Also, GraphQL enables shorter development cycles as there is no management overhead of multiple endpoints as traditionally needed with REST APIs. With additional features like authentication or realtime data, production ready applications can be quickly built using GraphQL.
