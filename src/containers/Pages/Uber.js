        ...
        <div style={styles.well}>
          <div style={containerStyle}>
            <div style={{paddingRight: '30px'}}>
              ...
              <ul>
                <li style={styles.li}><Link to={'todo_list_1'}> Step 1 - Search Header</Link></li>
                <li style={styles.li}><Link to={'todo_list_2'}> Step 2 - Results List</Link></li>
                <li style={styles.li}><Link to={'todo_list_3'}> Step 3 - Map & Geolocation</Link></li>
                <li style={styles.li}><Link to={'todo_list_3'}> Step 4 - UI Polish</Link></li>
              </ul>
            </div>
            <div>
              <img
